...
table with parameters used to generate HW tables.
...
cap on Ncore: 512 (if we get something hire it usually indicates that something is wrong, i.e., special combination of parameters in conflic with our generic performance requirements).

color-code lines that do violate conditions?
